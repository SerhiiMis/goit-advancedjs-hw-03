import{i as h,S as E}from"./assets/vendor-Dg3uDB0e.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const t of document.querySelectorAll('link[rel="modulepreload"]'))o(t);new MutationObserver(t=>{for(const a of t)if(a.type==="childList")for(const c of a.addedNodes)c.tagName==="LINK"&&c.rel==="modulepreload"&&o(c)}).observe(document,{childList:!0,subtree:!0});function r(t){const a={};return t.integrity&&(a.integrity=t.integrity),t.referrerPolicy&&(a.referrerPolicy=t.referrerPolicy),t.crossOrigin==="use-credentials"?a.credentials="include":t.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function o(t){if(t.ep)return;t.ep=!0;const a=r(t);fetch(t.href,a)}})();const S=VITE_API_KEY,P="https://pixabay.com/api/?",I="q",d=new URLSearchParams({key:S,orientation:"horizontal",image_type:"photo",safesearch:!0,per_page:12});function p(s,e=1){const r=$(s);d.set(I,r),d.set("page",e);const o=P+d.toString();return console.log("API URL:",o),fetch(o).then(t=>{if(!t.ok)throw new Error(`Error fetching images with status ${t.status} and response ${t.statusText}`);return t.json()})}function $(s){const e=s.split(/\s+/);let r="";for(const o of e){if((r+"+"+o).length>100)break;r+=(r?"+":"")+o}return r}const g=3e3,y="topRight";function u(s){h.warning({message:s,timeout:g,position:y,close:!1})}function b(s){h.error({message:s,timeout:g,position:y,close:!1})}function L(s,e=!1){if(s.length===0){b("Sorry, there are no images matching your search query. Please try again!");return}const r=T(s);e?f.insertAdjacentHTML("beforeend",r):f.innerHTML=r}const T=s=>s.map(e=>`<li class="gallery-item">
